...
public class CalculatorBalancer implements Calculator{
    ...
    public CalculatorBalancer(Registry server, int methode) throws RemoteException{
        this.server = server;
        this.last = 1;
    ...
    public void setTimer(long ms){this.timer = ms;}
    public void setMethode(int m){this.methode=m;}
}